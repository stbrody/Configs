...
# Set scons flags
export SCONSFLAGS="LINKFLAGS=-fuse-ld=gold --link-model=dynamic -j$_COMPILE_THREADS --ssl CC=/opt/mongodbtoolchain/v2/bin/gcc CXX=/opt/mongodbtoolchain/v2/bin/g++"
